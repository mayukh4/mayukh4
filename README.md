...
- **Programming:** Python, C, C++, HDL
- **Hardware/Design:** FPGA, MATLAB Simulink
- **Specialties:** Radio instrumentation, experimental astrophysics, hardware-software integration
...
- 🌐 [mayukhbagchi.com](https://mayukhbagchi.com)
- 💼 [LinkedIn](https://www.linkedin.com/in/mayukh-bagchi/)
- 📺 [YouTube](https://www.youtube.com/@mayukh_bagchi)
...
<!--
**mayukh4/mayukh4** is a ✨ special ✨ repository because its `README.md` appears on your GitHub profile.
-->
